...
![histogram](src= https://github.com/angelicacodes/book_recommendation/blob/main/reports/Visualizations/book_ratings.png width="200" height="200")
...
- Scrapping more data to add to the dataset
